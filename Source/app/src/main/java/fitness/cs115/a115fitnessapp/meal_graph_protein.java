...
public class meal_graph_protein extends AppCompatActivity {
    ...
    private void SetUpGraph() {
        ...
        for (String s : arrTblNames) {
            try {
                ...
                System.out.println("total protein is: " + mydb.getTotalProtein());
                foodData.put(string_ISO8601_to_Date(s), mydb.getTotalProtein());//call function that gives calories associated with that specific day);
            }
        }
