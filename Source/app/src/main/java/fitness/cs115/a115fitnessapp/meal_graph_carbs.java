...
public class meal_graph_carbs extends AppCompatActivity {
    ...
    private void SetUpGraph() {
        ...
        for (String s : arrTblNames) {
            try {
                ...
                System.out.println("total carbs is: " + mydb.getTotalCarbs());
                foodData.put(string_ISO8601_to_Date(s), mydb.getTotalCarbs());//call function that gives calories associated with that specific day);
            }
        }
